...
- Latin Vulgate (LV)
- Douay Rheims - Challoner (DR)
- Jerusalem Bibe (JB)
- New Catholiic Bible (NCB) [Work in Progress]
...
<table cellpadding="0" cellspacing="0" class="db-table">
   ...
   <tr>
      ...
      <td></td>
      <td>0</td>
      <td>1=Catholic, 2=Anglican, 3=Both, 4=Neither</td>
   </tr>
   <tr>
      <td>differences</td>
      <td>tinyint(3)</td>
      ...
      <td></td>
      <td>0</td>
      <td>flag of anglican/catholic versions are structurally different, ie Psalms</td>
   </tr>
</table>
<br />
